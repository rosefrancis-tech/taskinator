...
// Save tasks for local storage
var saveTasks = function() {
  localStorage.setItem("tasks", JSON.stringify(tasks));
};

// Retreive from local storage and display to the browser
var loadtasks = function() {
  
  // Retrieve fom local storage
...
// the following can be replaced with the above for loop for clearing technical debt with some changes in createTaskEl()
  // Display in correspondng elements in browser
  for (i = 0; i < savedTasks.length; i++) {
    ...
    taskInfoEl.className = "task-info";
    taskInfoEl.innerHTML =
      "<h3 class='task-name'>" + savedTasks[i].name + "</h3><span class='task-type'>" + savedTasks[i].type + "</span>";
    listItemEl.appendChild(taskInfoEl);
